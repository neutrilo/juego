...
#Load audio file
mixer.music.load('Raiden Shogun.mp3') #musica
    ...
    for event in ev:
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_LEFT:
                ...
                mixer.music.load('Arknights.mp3')
                mixer.music.play()
    ...
    for y in range(0, nxC):
        for x in range (0, nyC):
           ...
           # Si la celda está "viva" pintamos un recuadro relleno de color
                ...
                pygame.draw.polygon(screen, (0, 147, 255), poly, 0)
            else:
                pygame.draw.polygon(screen, (100, 127, 130), poly, 0)
#color
