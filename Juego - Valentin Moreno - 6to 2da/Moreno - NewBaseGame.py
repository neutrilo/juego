    ...
    for y in range(0, nxC):
        for x in range (0, nyC):
           ...
           # Si la celda está "viva" pintamos un recuadro relleno de color
                ...
                pygame.draw.polygon(screen, (250, 30, 20), poly, 0)
            elif gameState[x, y] == 2:
                pygame.draw.polygon(screen, (250, 255, 20), poly, 0)
            else:
                pygame.draw.polygon(screen, (120, 60, 230), poly, 0) #color
